        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ route('adProd.create') }}">Add Product</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('adProd.index') }}">Show Products</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="orders">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ route('orders', ['type' => 'new']) }}">New
                            Orders</a></li>
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('orders', ['type' => 'review']) }}">Reviewed Orders</a>
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('orders', ['type' => 'complete']) }}">Completed Orders</a>
                    </li>
                </ul>
            </div>
        </li>
